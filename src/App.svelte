...
<div class="page">
  ...
  <main>
    <section class="content">
      <div class="row">
        <div class="img-col">
          <img class="pixel" src={doomImg} alt="Doom (1993) screenshot" />
          <span class="caption">doom (1993) by id Software</span>
        </div>
        <div class="text-col">
          <p>MAKE RETRO THEMED PROJECTS IN GODOT(OR OTHER GAME ENGINES/FRAMEWORKS)</p>
        </div>
      </div>
